...
class FoodItemForm(forms.ModelForm):
    ...
    image = forms.FileField(widget=forms.FileInput(attrs={'class': "block w-full text-sm text-gray-400 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400", "placeholder": "image"}), validators=[allowed_image_ext])
